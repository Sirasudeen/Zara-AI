 ...
 sx={{display:"flex", overflow:"hidden",minWidth:"100vw"}}>
  ...
  <Box display="flex" flexDirection="column" alignItems="flex-start" gap="2rem" marginTop="2rem">
        ...
        {isBigScreen ? (<Grid left={'10rem'} position={'absolute'} container spacing={4}>
          ...
          (      
            <Box
            sx={{ display:"flex",mt:"10vh", flexDirection:"column",alignItems:"center",gap:"clamp(1rem,1rem + 40vh,30vh)"}}
            >
                <Box>
                <Magnet disabled={false} magnetStrength={20}>
...
stroke="#1E3E62" strokeWidth="3"/>
      ...
      >
        ...
        <Typography
        className='How'
          sx={{  fontWeight: 700, color: '#1E3E62',mt:"15vh",ml:"clamp(0.2rem,0.1rem + 0.7vw,10vw)", marginBottom: '2rem',fontSize:"clamp(2rem,1rem + 8vw,9rem)",width:"50vw" }}
        >
          HOW IT WORKS
        </Typography>
        </Box>
